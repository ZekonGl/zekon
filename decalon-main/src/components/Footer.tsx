    ...
    <footer className="bg-gray-900 text-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="col-span-1 md:col-span-2">
            ...
            <p className="text-gray-400 mb-4">
              Premium multimodal logistics across air, sea, road and rail — delivering worldwide with confidence.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li className="flex items-start gap-2">
                ...
                <span className="text-gray-400">info@zekon.co</span>
              </li>
              <li className="flex items-start gap-2">
        ...
        <div className="border-t border-gray-800 mt-8 pt-8 text-center text-gray-400">
          <p>&copy; {new Date().getFullYear()} Zekong Global Logistics LLC. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
