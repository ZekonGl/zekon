        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-3xl mx-auto text-center mb-16">
            <h1 className="text-4xl sm:text-5xl font-bold text-gray-900 mb-6">
              About Zekon Logistics
            </h1>
            <p className="text-xl text-gray-600 leading-relaxed">
              Built by experienced international traders who understand the complexities of cross-border logistics, Zekon emerged from a vision to transform how businesses move goods across the Caucasus and beyond.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div>
              ...
              <div className="space-y-4 text-gray-600 leading-relaxed">
                <p>
                  Founded by a team of experienced international traders, Zekon Logistics was born from firsthand experience with the challenges of moving cargo across the Caucasus region. We saw the need for a logistics partner that combined deep regional knowledge with modern digital capabilities.
                </p>
                <p>
                ...
                <p>
                  Today, Zekon operates a fleet of 500+ trucks and has successfully completed over 10,000 shipments, earning the trust of leading international businesses who demand excellence in every delivery.
                </p>
              </div>
            </div>
          </div>
